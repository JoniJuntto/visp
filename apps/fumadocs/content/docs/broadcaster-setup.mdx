...
description: Generate credentials, configure an encoder, and import the OBS collection.
icon: Video
---

## Generate credentials

1. Sign in to the portal with Twitch.
2. Open **Publishing devices** and create a device.
3. Copy that device's publish URL into the sending encoder.
4. Download the OBS scene collection while the read secret is still visible.
